...
public class Settings
{
    ...
    [Tooltip("The multiplier that will be applied to all damage dealt by crossbow weapons. " +
        "Positive numbers above 1.0 will increase the stamina damage whereas a value of 0 will remove it entirely.")]
    public double DamageMultiplier { get; set; } = 1.3;
